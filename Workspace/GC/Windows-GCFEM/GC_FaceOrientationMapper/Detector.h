...
public:
	...
	IplImage* Detector::getLastMask(double a,double b,double c,double d);//Returns the last region of detetion a,b,c and d should be less than 1
	...
	IplImage* GetImage(int ithDetection);
